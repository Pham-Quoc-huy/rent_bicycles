...
public class User {
    ...
    @Column
    private String googleId; // Cho đăng nhập Google
    
    @Column
    private String avatarUrl; // URL avatar từ Google
    ...
    // Google constructor
    public User(String email, String fullName, String googleId, String avatarUrl) {
        this();
        this.email = email;
        this.fullName = fullName;
